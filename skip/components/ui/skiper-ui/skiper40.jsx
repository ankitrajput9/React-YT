...
const Skiper40 = () => {
  return (
    <section className="h-full snap-y snap-mandatory overflow-y-scroll">
      <div
        className="relative flex h-full w-full  items-center justify-center gap-4 text-xl ">
        <Link001 href="mailto:hi@skiper-ui.com">Instagram</Link001>
        <Link002 href="mailto:hi@skiper-ui.com">Facebook</Link002>
        <Link003 href="mailto:hi@skiper-ui.com">GitHub</Link003>
        <Link004 href="mailto:hi@skiper-ui.com">Linkdin</Link004>
        <Link005 href="mailto:hi@skiper-ui.com">hi@skiper-ui.com</Link005>
        <Link014 href="https://web.telegram.org/k/#2145297156">Telegram</Link014>
...
export { Link000, Link001, Link002, Link003, Link004,Link014, Link005, Skiper40 };
